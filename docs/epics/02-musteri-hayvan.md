...
- Bu iki buton müşteri detayında, randevu detayında ve müşteri listesinde (mobilde satırı sola kaydırınca) bulunur.
- WhatsApp yüklü değilse web üzerinden WhatsApp açılır.
- Web'de "Ara" `tel:` linkini, "WhatsApp" `wa.me` linkini açar; ayrı bir davranış yoktur.
