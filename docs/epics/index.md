...
| K47 | Owner web back office **ayrı bir React uygulamasıdır**. MVP'de önce mobil yapılır; web sonra gelir. "Mobil + Web" etiketi hedefi belirtir, yapılış sırasını değil. | Public web yüzeyi (K14) bundan ayrıdır ve NestJS'te kalır. Monorepo'da yeri `apps/web`'dir; o uygulama açılana kadar "Mobil + Web" story'ler mobilde tamamlanır. |
